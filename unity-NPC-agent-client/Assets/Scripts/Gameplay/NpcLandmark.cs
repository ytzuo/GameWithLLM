...
public sealed class NpcLandmark : MonoBehaviour, IGameplayWorldTarget
{
    ...
    public string WorldTargetId => TargetId;
    public string WorldTargetDisplayName => DisplayName;
    public string WorldTargetCategory => "landmark";
    public bool IsDynamicWorldTarget => false;
