...
public class InventoryComponent : MonoBehaviour
{
    ...
    public void ConfigureContainerId(string containerId)
    {
    ...
    /// </summary>
    public bool RestoreSlots(IReadOnlyList<ItemData> items, IReadOnlyList<int> quantities, out string error)
    {
